...
{
    // This DraggableUIPanel class inherits from DraggableUIPanel
    // Inheriting is a great tool for UI design. By inheriting, we get the background drawing for free from DraggableUIPanel
    ...
    // DraggableUIPanel does not prevent the player from using items when the mouse is clicked, so we've added that as well
    public class DraggableUIPanel : UIPanel
    {
        // Stores the offset from the top left of the DraggableUIPanel while dragging
